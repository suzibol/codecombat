module.exports = nativeDescription: "Nederlands", englishDescription: "Dutch", translation:
  ...
  new_home:
    ...
    built_for_teachers_blurb: "Het kan vaak overweldigend voelen om kinderen te leren programmeren. CodeCombat helpt alle leraren om leerlingen te leren programmeren in JavaScript of Python, twee van de meest populaire programmeertalen. Met een uitgebreid curriculum wat zes Computer Science onderdelen bevat, en het leren versterkt door projectgebaseerde game-ontwikkeling en web-ontwikkeling, zullen kinderen vooruitgang boeken op hun reis van basis-syntaxis naar recursie!"
    built_for_teachers_subtitle1: "Computer Wetenschap"
    built_for_teachers_subblurb1: "Beginnend met onze gratis cursus Inleiding tot Computerwetenschap, beheersen leerlingen kernconcepten van programmeren zoals while / for loops, functies en algoritmes."
    built_for_teachers_subtitle2: "Game Ontwikkeling"
    built_for_teachers_subblurb2: "Leerlingen bouwen doolhoven en gebruiken basis input-handling om hun eigen spellen te programmeren die kunnen worden gedeeld met vrienden en familie."
    built_for_teachers_subtitle3: "Web Ontwikkeling"
    built_for_teachers_subblurb3: "Met behulp van HTML, CSS en jQuery, strekken de leerlingen hun creatieve spieren door hun eigen webpagina's te programmeren, met een aangepaste URL om te delen met hun klasgenoten."
    century_skills_title: "21ste-Eeuwse Vaardigheden (21st Century Skills)"
    century_skills_blurb1: "Leerlingen laten hun Held niet alleen een Level hoger komen, ze gaan zelf ook een Level Hoger."
    century_skills_quote1: "Als je het verpest ...dan denk je na over alle mogelijke manieren om het te repareren, en probeert het dan opnieuw. Ik zou hier niet zijn gekomen zonder hard te werken."
    century_skills_subtitle1: "Kritisch Denken"
    century_skills_subblurb1: "Met codeerpuzzels die van nature stijgen in steeds uitdagendere levels, zorgt het programmeerspel van CodeCombat ervoor dat kinderen altijd kritisch denken."
    century_skills_quote2: "Iedereen om me heen maakte doolhoven, dus ik dacht "Pak de vlag" en dat is wat ik deed."
    century_skills_subtitle2: "Creativiteit"
    century_skills_subblurb2: "CodeCombat moedigt studenten aan om hun creativiteit te laten zien door hun eigen games en webpagina's te bouwen en te delen."
    century_skills_quote3: "Als ik vast kwam te zitten op een level, ging ik met mensen om me heen eraan werken totdat we er samen achterkwamen wat de oplossing was."
    century_skills_subtitle3: "Samenwerking"
    century_skills_subblurb3: "Gedurende het spel zijn er mogelijkheden voor studenten om samen te werken wanneer ze vastlopen en om samen te werken met behulp van onze Pair Programming Guide, programmeergids voor 'paren', twee personen samen dus."
    century_skills_quote4: "Ik heb altijd het streven gehad om videogames te ontwerpen en te leren programmeren ... dit geeft me een goed beginpunt."
    century_skills_subtitle4: "Communicatie"
    century_skills_subblurb4: "Programmeren zorg ervoor dat kinderen nieuwe vormen van communicatie oefenen, waaronder communiceren met de computer zelf en hun ideeën overdragen met behulp van de meest efficiënte code."
    classroom_in_box_title: "We Streven Ernaar:"
    classroom_in_box_blurb1: "Betrek elke student bij de les zodat ze geloven dat programmeren voor hen is."
    classroom_in_box_blurb2: "Geef elke onderwijzer de mogelijkheid om zelfverzekerd te zijn bij het onderwijzen van codering."
    classroom_in_box_blurb3: "Inspireer alle schoolleiders om een computerwetenschappelijk programma van wereldklasse te maken."
#    creativity_rigor_title: "Waar Creativiteit en Strengheid elkaar Ontmoeten"
    creativity_rigor_subtitle1: "Maak coderen leuk en leer praktijkvaardigheden."
    creativity_rigor_blurb1: "Leerlingen typen echte Python en JavaScript tijdens het spelen van spellen die trial-and-error, kritisch denken en creativiteit stimuleren. Studenten passen vervolgens de codeervaardigheden toe die ze hebben geleerd door hun eigen games en websites te ontwikkelen in projectgebaseerde cursussen."
    creativity_rigor_subtitle2: "Bereik studenten op hun niveau"
    creativity_rigor_blurb2: "Elk CodeCombat-level wordt gebaseerd op miljoenen datapunten en is geoptimaliseerd om zich aan elke leerling aan te passen. Praktijklevels en hints helpen leerlingen wanneer ze vastlopen, en uitdagingslevels beoordelen het leren van leerlingen gedurende het spel."
    creativity_rigor_subtitle3: "Gebouwd voor alle leraren, ongeacht hun ervaring."
    creativity_rigor_blurb3: "CodeCombat's op eigen tempo, op standaarden afgestemde curriculum maakt computerwetenschap voor iedereen mogelijk. CodeCombat rust docenten uit met de training, educatieve middelen en toegewijde ondersteuning om zich zelfverzekerd en succesvol te voelen in de klas."
    featured_partners_title1: "Uitgelicht In"
    featured_partners_title2: "Awards & Partners"
    featured_partners_blurb1: "CollegeBoard Goedgekeurde Aanbieder"
    featured_partners_blurb2: "Beste Creativiteits-tool voor studenten"
    featured_partners_blurb3: "Beste keuze voor leren"
    ...
    for_leaders_blurb: "Een uitgebreid, op standaarden afgestemd computerwetenschappelijk programma"
    for_leaders_subtitle1: "Eenvoudige implementatie"
    for_leaders_subblurb1: "Een webgebaseerd programma dat geen IT-ondersteuning vereist. Ga binnen 5 minuten aan de slag met Google of Clever Single Sign-On (SSO)."
    for_leaders_subtitle2: "Volledig Programmeer-Curriculum"
    for_leaders_subblurb2: "Een op standaarden afgestemd curriculum met leermiddelen en professionele ontwikkeling om elke leraar in staat te stellen Computerwetenschappen te geven."
    for_leaders_subtitle3: "Flexibele Use Cases"
    for_leaders_subblurb3: "Of u nu een keuzevak voor de middelbare school, een CTE-traject of een AP Computer Science Principles-cursus wilt bouwen, CodeCombat is op maat gemaakt om aan uw behoeften te voldoen."
    for_leaders_subtitle4: "Praktijkvaardigheden voor in de Echte Wereld"
    for_leaders_subblurb4: "Leerlingen krijgen durf en ontwikkelen een groeimindset door coderingsuitdagingen die hen voorbereiden op de 500K+ open computing-banen."
    for_teachers_title: "Voor Leraren"
    for_teachers_blurb: "Hulpmiddelen om het Potentieel van Studenten te Bevrijden"
    for_teachers_subtitle1: "Projectmatig Leren"
    for_teachers_subblurb1: "Bevorder creativiteit, probleemoplossend vermogen en vertrouwen in projectmatige cursussen waarbij studenten hun eigen games en webpagina's ontwikkelen."
    for_teachers_subtitle2: "Leraren Dashboard"
    for_teachers_subblurb2: "Bekijk gegevens over de voortgang van studenten, ontdek leerplannen en krijg toegang tot real-time ondersteuning om het leren van studenten te verbeteren."
    for_teachers_subtitle3: "Ingebouwde beoordelingen"
    for_teachers_subblurb3: "Personaliseer instructie en zorg ervoor dat studenten kernconcepten met formatieve en summatieve beoordelingen begrijpen."
    for_teachers_subtitle4: "Automatische differentiatie"
    for_teachers_subblurb4: "Betrek alle leerlingen erbij in een divers klaslokaal met oefenlevels die zich aanpassen aan de leerbehoeften van elke student."
    game_based_blurb: "CodeCombat is een op games gebaseerd computerwetenschappelijk programma waarbij studenten echte code typen en hun personages in realtime laten reageren."
    get_started: "Ga aan de Slag"
    global_title: "Word lid van onze wereldwijde community van leerlingen en onderwijzers"
    global_subtitle1: "Leerlingen"
    global_subtitle2: "Regels met Code"
    ...
    quotes_quote1: "Noem elk ander programma online, ik heb het geprobeerd. Geen van hen komt in de buurt van CodeCombat. Elke leraar die wil dat zijn leerlingen leren coderen ... begin hier!"
    quotes_quote2: " Ik was verrast over hoe eenvoudig en intuïtief CodeCombat het leren van computerwetenschappen maakt. De scores op het AP-examen waren veel hoger dan ik had verwacht en ik geloof dat CodeCombat de reden is waarom dit het geval was."
    quotes_quote3: "CodeCombat was het meest nuttig voor het leren van de programmeermogelijkheden aan mijn studenten, mijn man is een software-engineer en hij heeft al mijn programma's getest, hij zei dat dit zijn eerste keuze was."
    quotes_quote4: "De feedback ... is zo positief dat we een klas in Computerwetenschap structureren met CodeCombat als basis. Het programma betrekt de leerlingen er echt bij met een gaming-style platform dat tegelijkertijd vermakelijk en leerzaam is. Ga zo door, CodeCombat!"
    ...
    teachers_love_codecombat_blurb1: "Geven door dat hun studenten het leuk vinden om CodeCombat te gebruiken om te leren coderen"
    teachers_love_codecombat_blurb2: "Zouden CodeCombat aanbevelen aan andere informatica-leraren"
    teachers_love_codecombat_blurb3: "Zeggen dat CodeCombat hen helpt om probleemoplossend vermogen van studenten te ondersteunen"
    teachers_love_codecombat_subblurb: "In samenwerking met McREL International, een voorloper in op onderzoek gebaseerde begeleiding en evaluaties van onderwijstechnologie."
    try_the_game: "Probeer het spel uit"
    ...
    request_quote: "Vraag een Citaat Aan"
